...
if tokencache == ngx.null then
    ...
    tokentool.add_bearer_token_ttl(cas_loginname,token.expires_in,token.token_type.." "..token.access_token)
    ngx.req.set_header("Authorization", tokentool.bearer_auth(token.access_token))
else
